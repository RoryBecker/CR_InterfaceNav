...
#Region "NavFromInterface"
    ...
    Public Sub CreateNavFromInterface()
        Dim NavFromInterface As New Library.NavigationProvider(components)
...
#Region "NavFromInterfaceMethod"
    ...
    Public Sub CreateNavFromInterfaceMethod()
        Dim ToImplementorFromInterfaceMethod As New Library.NavigationProvider(components)
...
#Region "NavFromVarDeclaration"
    ...
    Public Sub CreateNavFromVarDeclaration()
        Dim NavFromVarDeclaration As New Library.NavigationProvider(components)
...
#Region "NavFromVarReference"
    Public Sub CreateNavFromVarReference()
        Dim NavFromVarReference As New Library.NavigationProvider(components)
...
#Region "NavFromMethodReference"
    Public Sub CreateNavFromMethodReference()
        Dim NavFromMethodReference As New Library.NavigationProvider(components)
...
#Region "NavFromClassImplementingInterface"
    Public Sub CreateNavFromClassImplementingInterface()
        Dim NavFromClassImplementingInterface As New Library.NavigationProvider(components)
